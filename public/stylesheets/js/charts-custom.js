...
$(document).ready(function () {
    ...
    var fast = fastball_months;
    var curve = curveball_months;
    var change = changeup_months;
...
//                },
    ...
    var pieChartExample = new Chart(PIECHARTEXMPLE, {
        ...
        data: {
            ...
            datasets: [
                {
                    data: [fastball_data.length, curveball_data.length, changeup_data.length],
                    borderWidth: [1, 1, 1],
                    backgroundColor: [
                        brandPrimary,
                        "rgba(75,192,192,1)",
